	...
	; Compiler options:
	;
	; -o20180906002.cof -m20180906002.map --summary=default \
	; --output=default 20180906002.p1 --chip=16F877A -P --runtime=default \
	; --opt=default -D__DEBUG=1 --rom=default,-1f00-1fff \
	; --ram=default,-0-0,-70-70,-80-80,-f0-f0,-100-100,-170-170,-180-180,-1e5-1f0 \
	; --debugger=pickit3 -g --asmlist --errformat=Error   [%n] %f; %l.%c %s \
